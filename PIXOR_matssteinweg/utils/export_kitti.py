...
class KittiConverter:
    def __init__(self,
        ...
        :param image_count: Number of images to convert. Set to -1 to convert all images.
        :param nusc_version: nuScenes version to use.
        :param split: Dataset split to use. valid options are: 'train', 'val', 'test,' 'mini_train', 'mini_val'.
        """
        ...
        self.nusc = NuScenes(dataroot=dataroot, version=nusc_version)
