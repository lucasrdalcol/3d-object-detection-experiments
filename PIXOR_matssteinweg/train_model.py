...
class EarlyStopping:
    ...
    def save_checkpoint(self, val_loss, model):
        ...
        # save model
        torch.save(model.state_dict(), '/media/lucasrdalcol/data/phd_research/models/3d-object-detection-experiments/PIXOR_matssteinweg/PIXOR_Epoch_' + str(self.best_epoch) + '.pt')
...
def train_model(model, optimizer, scheduler, data_loaders, n_epochs=25, show_times=False):
    ...
    for epoch in range(n_epochs):
        ...
        # save metrics
        np.savez('/media/lucasrdalcol/data/phd_research/results/3d-object-detection-experiments/PIXOR_matssteinweg/metrics/metrics_' + str(epoch + 1) + '.npz', history=metrics)
...
if __name__ == '__main__':
    ...
    np.savez('/media/lucasrdalcol/data/phd_research/results/3d-object-detection-experiments/PIXOR_matssteinweg/metrics/history.npz', history=history)
